...
The author/ directory contains the logic for generating the v3.pm
module.

=head1 DATA FILES

The YAML files in the author/data directory have lines
like this:
...
be injected in place of :bar.

=head2 ?

If the PATH ends with a ? then this signifies that the API
